<head>
    <meta charset="utf-8" />
    <title>ASWAAT | ADMIN</title>
    <meta name="description" content="ASWAAT" />
    ...
    <meta name="apple-mobile-web-app-title" content="ASWAAT">
    ...
    <link rel="stylesheet" href="{{ asset('assets/datatables/jquery.dataTables.min.css')}}" type="text/css" />
